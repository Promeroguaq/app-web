...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
    ...
    <a href="{{ route('puntos-interes.parques-tematicos.show', $item->id) }}" class="cinematic-card group cursor-pointer block">
        <div class="relative h-72 overflow-hidden rounded-t-3xl">
            ...
            @else
                <div class="w-full h-full bg-gradient-to-br from-cyan-600 to-sky-700 flex items-center justify-center">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                <div class="flex gap-4 text-xs md:text-sm font-medium mb-2">
                    <span class="flex items-center gap-1">
                        <i class="fas fa-ticket-alt"></i> Atracciones
                    </span>
                    <span class="flex items-center gap-1">
