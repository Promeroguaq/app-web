...
// Consultar los datos reales de la tabla actividad_parques
$stmt = $pdo->prepare("SELECT id_actividad, nombre_actividad_en_parque, descripcion FROM actividad_parques ORDER BY id_actividad");
$stmt->execute();
